<?php 
    ...
    if(isset($_POST)){
        ...
        $_SESSION['shipping']['phone'] = $_POST['phone'];
            ...
            <!-- Item-->
             <?php foreach ($cart_items as $key => $item) { ?>
                ...
                <div class="d-sm-flex text-center text-sm-start">
                    ...
                    <div class="pt-2">
                    <h3 class="product-title fs-base mb-2"><a href="product.php?id=<?= $item['pro']['id']  ?>"><?= substr($item['pro']['name'],0,80) ?></a></h3>
                    <div class="fs-sm"><span class="text-muted me-2">Unit price:</span><?= $item['pro']['price']  ?></div>
                    <div class="fs-lg text-accent pt-2">$<?= $item['pro']['price']*$item['quantity']  ?>.<small>00</small></div>
                    </div>
                </div>
