...
<div class="container py-4 py-lg-5 my-4">
        <div class="row">
          <div class="col-md-6">
            <div class="card border-0 shadow">
              <div class="card-body">
                ...
                <form class="needs-validation"  action="login-logic.php" method="post" novalidate>
          ...
          <div class="col-md-6 pt-4 mt-3 mt-md-0">
            ...
            <form class="needs-validation" action="registration-logic.php" method="post" novalidate>
