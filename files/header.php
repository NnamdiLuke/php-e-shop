...
if (isset($_SESSION['cart']) && is_array($_SESSION['cart'])) {
    ...
    // Only display 4 in dropdown
    $cart_items = array_slice($cart_items, 0, 4);
}
        ...
        <header class="shadow-sm">
            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="<?= url('') ?>"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="<?= url('') ?>"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
                                ...
                                <?php  } else { ?>
                                    ...
                                    <div class="navbar-tool dropdown ms-3">
                                        ...
                                        <a class="navbar-tool-text" href="shop-cart.html">
                                            <small>My Cart</small>$<?= $cart_total ?>.00
                                        </a>
                                        <!-- Cart dropdown-->
                                                ...
                                                <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                                                    <?php foreach ($cart_items as $key => $item) { ?>
                                                        <div class="widget-cart-item pb-2 border-bottom">
                                                            <a href="cart-process-remove.php?id=<?= $item['pro']['id']  ?>" class="btn-close text-danger" type="button" aria-label="Remove">
